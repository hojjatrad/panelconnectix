...
class ApiController {
    ...
    public function checkAppUpdate(): void {
        ...
        self::jsonSuccess([
            ...
            'changelog' => "• بروزرسانی مستقیم درون‌برنامه‌ای و نصب خودکار بدون نیاز به مرورگر یا حذف نسخه قبلی\n• اتصال هوشمند بر اساس کمترین پینگ (Smart Connect)\n• تونل‌بندی هوشمند و دور زدن برنامه‌های بانکی و ایرانی (Split Tunneling)\n• اشتراک‌گذاری اینترنت با تلویزیون هوشمند و کنسول‌های بازی (VPN Hotspot & Proxy Share)\n• اتصال مجدد خودکار و جابجایی هوشمند سرور در صورت افت کیفیت (Failover)\n• صندوق اطلاعیه‌ها و پیام‌های درون‌برنامه‌ای با پشتیبانی سریع",
